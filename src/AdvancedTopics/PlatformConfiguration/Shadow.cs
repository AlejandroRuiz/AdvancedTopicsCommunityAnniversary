namespace AdvancedTopics.PlatformConfiguration.iOS
{
    using System.Linq;
    using Xamarin.Forms;
    ...
    {
        const string EffectName = "GroupName.ShadowEffectPlatform";
...
namespace AdvancedTopics.PlatformConfiguration.Android
{
    using System.Linq;
    using Xamarin.Forms;
    using Xamarin.Forms.PlatformConfiguration;
